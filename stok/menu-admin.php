  <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class=" sidebar">
          ...
          <div class="user-panel mt-3 pb-3 mb-3 d-flex">
              <div class="image">
                  <img src="../img/logo/aldi.jpg" class="img-circle elevation-2" alt="Foto Admin"
                      style="height: 50px; width: 50px; margin-left: -10px;">
              </div>
              <div class=" info mt-2 d-flex">
                  <a href="#" class="d-block" style="font-weight: bold;">Admin <?php echo $result['nama_user']; ?></a>
              </div>
          </div>
          ...
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                  ...
                  <li class="nav-item">
                      <a href="?page=akun-data" class="nav-link">
